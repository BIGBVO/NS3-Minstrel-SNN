	...
	while (seed < 8){
		...
		while (index < 5){
			...
			if (index == 0){
				...
				result_path = "./Result/AARF/1_contentions/";
			} else if (index == 1){
				RAW_path = "./OptimalRawGroup/RAW/raw1.txt";
				result_path = "./Result/AARF/2_contentions/";
			} else if (index == 2){
				RAW_path = "./OptimalRawGroup/RAW/raw2.txt";
				result_path = "./Result/AARF/4_contentions/";
			} else if (index == 3){
				RAW_path = "./OptimalRawGroup/RAW/raw3.txt";
				result_path = "./Result/AARF/8_contentions/";
			}  else if (index == 4){
				RAW_path = "./OptimalRawGroup/RAW/raw4.txt";
				result_path = "./Result/AARF/16_contentions/";
			} else {
