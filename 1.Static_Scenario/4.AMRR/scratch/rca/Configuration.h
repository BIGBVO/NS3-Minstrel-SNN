...
struct Configuration {
	...
	//string trafficType = "tcpsensor"; // important - udp is considered to be only uplink in NodeStatistics::GetPacketLoss tcpipcamera tcpfirmware
	...
	uint8_t pageIndex = 0;
	uint32_t pageSliceLength=4; //  Number of blocks in each TIM for the associated page except for the last TIM (1-31) (value 0 is reserved);
	...
	string TrafficPath = "./OptimalRawGroup/traffic/traffic_generated/FN_128.txt";
	//string TrafficPath="./OptimalRawGroup/traffic/traffic_generated/128_0.15.txt";
	bool S1g1MfieldEnabled=false;
	string RAWConfigFile = "./OptimalRawGroup/Minstrel_DNN/raw.txt";
	string DataMode = "MCS4_7"; //TODO copy this from Dwight, OfdmRate7_8MbpsBW2MHz MCS2
	string OutputPath = "./OptimalRawGroup/";
	string resultPath = "./Result/Paper/Minstrel/test.txt";
