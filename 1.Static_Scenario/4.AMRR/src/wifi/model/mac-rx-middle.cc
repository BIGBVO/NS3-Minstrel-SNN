...
void
MacRxMiddle::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr, std::map <Mac48Address, uint16_t> mcs_map, double signal, double noise, double interference, double mcs_index, double psr)
{
  ...
  m_callback (agregate, hdr, mcs_map, signal, noise, interference, mcs_index, psr);
}
