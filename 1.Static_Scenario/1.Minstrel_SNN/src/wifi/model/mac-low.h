...
public:
   ...
   */
  typedef Callback<void, Ptr<Packet>, const WifiMacHeader*, std::map <Mac48Address, uint16_t> , double, double, double, double, double> MacLowRxCallback;
   ...
   */
  void SetRxCallback (Callback<void,Ptr<Packet>,const WifiMacHeader *, std::map <Mac48Address, uint16_t>, double , double , double, double, double > callback);
  /**
   ...
   */
  void ReceiveOk (Ptr<Packet> packet, std::map <Mac48Address, uint16_t> mcs_map, double signal, double noise, double interference, double mcs_index, double psr, WifiTxVector txVector, WifiPreamble preamble, bool ampduSubframe);
  /**
   * \param packet packet received.
   * \param rxSnr snr of packet received.
   *
   ...
   *
   */
  void DeaggregateAmpduAndReceive (Ptr<Packet> aggregatedPacket,std::map <Mac48Address, uint16_t> mcs_map, double singal, double noise, double interference, double mcs_index, double psr, WifiTxVector txVector, WifiPreamble preamble);
  /**
...
private:
   ...
   * \param preamble
   */
  void ForwardDown (Ptr<const Packet> packet, const WifiMacHeader *hdr, std::map <Mac48Address, uint16_t> mcs_map,
   ...
   * \param preamble
   */
  void SendPacket (Ptr<const Packet> packet, std::map <Mac48Address, uint16_t> mcs_map, WifiTxVector txVector, WifiPreamble preamble, uint8_t packetType);
  /**
   ...
   */
  void SendDataPacket (std::map <Mac48Address, uint16_t> mcs_map);
  /**
  ...
  std::map <Mac48Address, uint16_t> m_mcs_map;
