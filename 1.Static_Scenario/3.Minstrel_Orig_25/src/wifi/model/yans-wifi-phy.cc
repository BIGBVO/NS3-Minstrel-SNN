      ...
      if (0.5 >= snrPer.per)
        {
          if (packet->GetSize() == 166){
            ...
            */
            ...
            outfile.open("/home/bigbvo/Desktop/NS3_80211.ah_AI_Minstrel/Result/TCP_Sensors/result26.txt", std::ios_base::app);
            outfile << packet->GetSize();
            outfile << "\t";
            outfile << snrPer.snr_comp.signal;
            outfile << "\t";
            outfile << snrPer.snr_comp.noise;
            outfile << "\t";
            outfile << snrPer.snr_comp.interference;
            outfile << "\t";
