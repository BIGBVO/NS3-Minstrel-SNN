...
public:
  ...
  void setPredictedRate (WifiRemoteStation *station, uint16_t mcs_index);

private:
  //overriden from base class
  virtual WifiRemoteStation * DoCreateStation (void) const;
  virtual void DoReportRxOk (WifiRemoteStation *station, uint16_t mcs_index,
  ...
  uint32_t FindRate (MinstrelWifiRemoteStation *station, double snr);
  ...
  //void DoSetPredictedRate (WifiRemoteStation *st, uint16_t mcs_index);
