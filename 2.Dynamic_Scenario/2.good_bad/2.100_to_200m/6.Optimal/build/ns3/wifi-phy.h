...
public:
   ...
   */
  typedef Callback<void, Ptr<Packet>,  std::map <Mac48Address, uint16_t>, double, double, double, double, double, WifiTxVector, enum WifiPreamble> RxOkCallback;
  /**
   ...
   */
  virtual void SendPacket (Ptr<const Packet> packet, std::map <Mac48Address, uint16_t> mcs_map, WifiTxVector txvector, enum WifiPreamble preamble, uint8_t packetType) = 0;
