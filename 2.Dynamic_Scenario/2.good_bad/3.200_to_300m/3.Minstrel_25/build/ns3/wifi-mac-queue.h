...
public:
   ...
   */
  void Enqueue (Ptr<const Packet> packet, const WifiMacHeader &hdr, const std::map <Mac48Address, uint16_t>);
  /**
   ...
   * \return the packet
   */
  Ptr<const Packet> Dequeue (WifiMacHeader *hdr, std::map <Mac48Address, uint16_t>* mcs_map);
  /**
