...
public:
   ...
   */
  void Send (Ptr<YansWifiPhy> sender, Ptr<const Packet> packet, std::map <Mac48Address, uint16_t> mcs_map,
  ...
  void SetChecker (uint16_t check);
  uint16_t GetChecker (void);
...
private:
   ...
   */
  void Receive (Data data ,Ptr<Packet> packet, double *atts,
