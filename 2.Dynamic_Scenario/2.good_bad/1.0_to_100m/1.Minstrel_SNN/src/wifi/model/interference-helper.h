...
private:
   ...
   */
  struct InterferenceHelper::SNR_comp CalculateSnr (double signal, double noiseInterference, WifiMode mode) const;
  /**
   ...
   */
  double CalculateChunkSuccessRate (InterferenceHelper::SNR_comp snr_comp, Time duration, WifiMode mode) const;
  /**
   ...
   */
  struct InterferenceHelper::PerInterference CalculatePlcpPayloadPer (Ptr<const Event> event, NiChanges *ni) const;
  /**
